function Export-CdfServiceTemplate {
    [CmdletBinding()]
    param (
    ...
    $ServiceTemplateFolder = Join-Path (Get-CdfProject).ServicesPath -ChildPath $Object.Name -AdditionalChildPath ("v" + ($Object.Version -replace "-PreRelease", ""))
