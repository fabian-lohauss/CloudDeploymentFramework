...
devcontainer build --image-name ghcr.io/fabian-lohauss/cdf-devcontainer:latest --platform "linux/amd64" --push false --workspace-folder . 
...
docker tag ghcr.io/fabian-lohauss/cdf-devcontainer ghcr.io/fabian-lohauss/cdf-devcontainer:v1.0
docker push ghcr.io/fabian-lohauss/cdf-devcontainer:latest
